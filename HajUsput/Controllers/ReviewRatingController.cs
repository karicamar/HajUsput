...
namespace HajUsput.Controllers
{
    ...
    public class ReviewRatingController : BaseCRUDController<hajUsput.Model.ReviewRating, ReviewRatingSearchObject, ReviewRatingInsertRequest, ReviewRatingUpdateRequest>

    {
        private readonly IReviewRatingService _reviewRatingService;
        public ReviewRatingController(ILogger<BaseController<hajUsput.Model.ReviewRating, ReviewRatingSearchObject>> logger, IReviewRatingService service) : base(logger, service)
        {
