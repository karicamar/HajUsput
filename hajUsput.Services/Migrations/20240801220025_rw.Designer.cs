            ...
            modelBuilder.Entity("hajUsput.Services.Database.Booking", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            BookingId = 1,
                            BookingDate = new DateTime(2024, 8, 2, 0, 0, 24, 217, DateTimeKind.Local).AddTicks(5514),
            ...
            modelBuilder.Entity("hajUsput.Services.Database.MessageNotification", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            MessageDate = new DateTime(2024, 8, 2, 0, 0, 24, 217, DateTimeKind.Local).AddTicks(5716),
                            ReceiverId = 2,
                            SenderId = 1
                        });
                });
            ...
            modelBuilder.Entity("hajUsput.Services.Database.Payment", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Amount = 20.00m,
                            PayerId = 2,
                            PaymentDate = new DateTime(2024, 8, 2, 0, 0, 24, 217, DateTimeKind.Local).AddTicks(5580),
            ...
            modelBuilder.Entity("hajUsput.Services.Database.ReviewRating", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Comments = "Great ride!",
                            DriverId = 4,
                            ReviewDate = new DateTime(2024, 8, 2, 0, 0, 24, 217, DateTimeKind.Local).AddTicks(5652),
                            ReviewerId = 2
                        });
                });
            ...
            modelBuilder.Entity("hajUsput.Services.Database.Ride", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            RideId = 1,
                            DepartureDate = new DateTime(2024, 8, 2, 0, 0, 24, 217, DateTimeKind.Local).AddTicks(5330),
            ...
            modelBuilder.Entity("hajUsput.Services.Database.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            RegistrationDate = new DateTime(2024, 8, 2, 0, 0, 24, 217, DateTimeKind.Local).AddTicks(5044),
                            Username = "admin"
                        },
                        new
                        {
                            ...
                            RegistrationDate = new DateTime(2024, 8, 2, 0, 0, 24, 217, DateTimeKind.Local).AddTicks(5136),
                            Username = "johndoe"
                        });
                });
