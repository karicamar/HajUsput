...
namespace hajUsput.Services.Migrations
{
    ...
    [Migration("20240722142125_distdur")]
    partial class distdur
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("hajUsput.Services.Database.Booking", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            BookingId = 1,
                            BookingDate = new DateTime(2024, 7, 22, 16, 21, 25, 219, DateTimeKind.Local).AddTicks(4845),
            ...
            modelBuilder.Entity("hajUsput.Services.Database.MessageNotification", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            MessageDate = new DateTime(2024, 7, 22, 16, 21, 25, 219, DateTimeKind.Local).AddTicks(5032),
                            ReceiverId = 2,
                            SenderId = 1
                        });
                });
            ...
            modelBuilder.Entity("hajUsput.Services.Database.Payment", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Amount = 20.00m,
                            PayerId = 2,
                            PaymentDate = new DateTime(2024, 7, 22, 16, 21, 25, 219, DateTimeKind.Local).AddTicks(4908),
            ...
            modelBuilder.Entity("hajUsput.Services.Database.ReviewRating", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ReviewId = 1,
                            Comments = "Great ride!",
                            ReviewDate = new DateTime(2024, 7, 22, 16, 21, 25, 219, DateTimeKind.Local).AddTicks(4972),
                            ReviewerId = 2,
                            RideId = 1
                        });
                });
            ...
            modelBuilder.Entity("hajUsput.Services.Database.Ride", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            RideId = 1,
                            DepartureDate = new DateTime(2024, 7, 22, 16, 21, 25, 219, DateTimeKind.Local).AddTicks(4790),
            ...
            modelBuilder.Entity("hajUsput.Services.Database.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            RegistrationDate = new DateTime(2024, 7, 22, 16, 21, 25, 219, DateTimeKind.Local).AddTicks(4336),
                            Username = "admin"
                        },
                        new
                        {
                            ...
                            RegistrationDate = new DateTime(2024, 7, 22, 16, 21, 25, 219, DateTimeKind.Local).AddTicks(4596),
                            Username = "johndoe"
                        });
                });
