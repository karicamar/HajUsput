...
namespace hajUsput.Services.Migrations
{
    ...
    [Migration("20240811134433_editdatetime")]
            ...
            modelBuilder.Entity("hajUsput.Services.Database.Booking", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            BookingId = 1,
                            BookingDate = new DateTime(2024, 8, 11, 15, 44, 32, 551, DateTimeKind.Local).AddTicks(5373),
            ...
            modelBuilder.Entity("hajUsput.Services.Database.MessageNotification", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            MessageDate = new DateTime(2024, 8, 11, 15, 44, 32, 551, DateTimeKind.Local).AddTicks(5460),
                            ReceiverId = 2,
                            SenderId = 1
                        });
                });
            ...
            modelBuilder.Entity("hajUsput.Services.Database.Payment", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Amount = 20.00m,
                            PayerId = 2,
                            PaymentDate = new DateTime(2024, 8, 11, 15, 44, 32, 551, DateTimeKind.Local).AddTicks(5407),
            ...
            modelBuilder.Entity("hajUsput.Services.Database.ReviewRating", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Comments = "Great ride!",
                            DriverId = 4,
                            ReviewDate = new DateTime(2024, 8, 11, 15, 44, 32, 551, DateTimeKind.Local).AddTicks(5434),
                            ReviewerId = 2
                        });
                });
            ...
            modelBuilder.Entity("hajUsput.Services.Database.Ride", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            RideId = 1,
                            DepartureDate = new DateTime(2024, 8, 11, 15, 44, 32, 551, DateTimeKind.Local).AddTicks(5336),
            ...
            modelBuilder.Entity("hajUsput.Services.Database.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            RegistrationDate = new DateTime(2024, 8, 11, 15, 44, 32, 551, DateTimeKind.Local).AddTicks(5085),
                            Username = "admin"
                        },
                        new
                        {
                            ...
                            RegistrationDate = new DateTime(2024, 8, 11, 15, 44, 32, 551, DateTimeKind.Local).AddTicks(5137),
                            Username = "johndoe"
                        });
                });
