...
namespace hajUsput.Services.Migrations
{
    ...
    [Migration("20240811135432_editdatetime1")]
    partial class editdatetime1
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("hajUsput.Services.Database.Booking", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            BookingId = 1,
                            BookingDate = new DateTime(2024, 8, 11, 15, 54, 32, 181, DateTimeKind.Local).AddTicks(1537),
            ...
            modelBuilder.Entity("hajUsput.Services.Database.MessageNotification", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            MessageDate = new DateTime(2024, 8, 11, 15, 54, 32, 181, DateTimeKind.Local).AddTicks(1623),
                            ReceiverId = 2,
                            SenderId = 1
                        });
                });
            ...
            modelBuilder.Entity("hajUsput.Services.Database.Payment", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Amount = 20.00m,
                            PayerId = 2,
                            PaymentDate = new DateTime(2024, 8, 11, 15, 54, 32, 181, DateTimeKind.Local).AddTicks(1567),
            ...
            modelBuilder.Entity("hajUsput.Services.Database.ReviewRating", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Comments = "Great ride!",
                            DriverId = 4,
                            ReviewDate = new DateTime(2024, 8, 11, 15, 54, 32, 181, DateTimeKind.Local).AddTicks(1593),
                            ReviewerId = 2
                        });
                });
            ...
            modelBuilder.Entity("hajUsput.Services.Database.Ride", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            RideId = 1,
                            DepartureDate = new DateTime(2024, 8, 11, 15, 54, 32, 181, DateTimeKind.Local).AddTicks(1505),
            ...
            modelBuilder.Entity("hajUsput.Services.Database.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            RegistrationDate = new DateTime(2024, 8, 11, 15, 54, 32, 181, DateTimeKind.Local).AddTicks(1203),
                            Username = "admin"
                        },
                        new
                        {
                            ...
                            RegistrationDate = new DateTime(2024, 8, 11, 15, 54, 32, 181, DateTimeKind.Local).AddTicks(1261),
                            Username = "johndoe"
                        });
                });
