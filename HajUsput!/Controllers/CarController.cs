...
namespace HajUsput_.Controllers
{
    ...
    {
        public CarController(ILogger<BaseController<Car, hajUsput.Model.SearchObjects.CarSearchObject>> logger, ICRUDService<Car, CarSearchObject, CarInsertRequest, CarUpdateRequest> service) : base(logger,service)
        {
        }
    }
}
